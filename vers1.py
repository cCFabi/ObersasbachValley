...
pg.display.set_caption('Obersasbach Valley made by Artur')
clock = pg.time.Clock()
selector = False
mov_x = 200
mov_y = 200
...
wheat_img = pg.transform.scale(pg.image.load("assets/Wheat.png").convert_alpha(), (12 * 2, 13 * 2))

cursor_img = pg.image.load("assets/cursor.png").convert_alpha()
pg.mouse.set_visible(False)
cursor_img_rect = cursor_img.get_rect()
# leiste = pg.image.load("menubar3.png")
leiste = pg.transform.scale(pg.image.load("assets/menubar.png").convert_alpha(), (188 * FAKTOR, 16 * FAKTOR))
